...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
        ...
        private huespedService huesped;
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(int idRegistro) {
		this.idRegistro = idRegistro;
                huesped = new huespedService();
		...
		contentPane.add(txtNreserva);
                txtNreserva.setText(""+idRegistro);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
                            ...
                            //txtNombre,txtApellido,txtTelefono,txtNreserva,txtFechaN,txtNacionalidad
                            LocalDate localDate = txtFechaN.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                            System.out.println(txtNombre.getText()+" "+txtApellido.getText()+" "+txtTelefono.getText()
                            +" "+txtNreserva.getText()+" ---- "+txtNacionalidad.getSelectedItem().toString()
                            +"--- "+localDate.getYear()+"/"+localDate.getMonthValue()+"/"+localDate.getDayOfMonth());
                            try {
                                //dispose();
                                var respuesta = huesped.insertar(txtNombre.getText(),txtApellido.getText(),
                                        localDate.getYear()+"/"+localDate.getMonthValue()+"/"+localDate.getDayOfMonth(),
                                        txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(), Integer.parseInt(txtNreserva.getText()));
                                System.out.println("Id: "+respuesta );
                                if(respuesta>0){
                            dispose();
                            }
